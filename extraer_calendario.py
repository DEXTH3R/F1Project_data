...
def obtener_df_calendario():
    # Configuración inicial idéntica
    ...
    # Dividimos en bloques (Lógica Original)
    ...
    # ==================== PARSEO BASE (TU LÓGICA ORIGINAL) ====================
    data = []
    for gp in gps:
        raw = gp.get('raw', '')
        row = {'GP': gp['GP']}

        # Fechas, Circuito, Longitud, Curvas
        ...
        # ==================== RÉCORD DE VUELTA (TU LÓGICA ORIGINAL) ====================
        ...
        # ==================== GANADOR Y POLE (TU LÓGICA ORIGINAL) ====================
        ...
        if len(podios) >= 3:
            ...
            row['Podio reciente'] = f"1º {podios2[0].strip()} | 2º {podios2[1].strip()} | 3º {podios2[2].strip()}" if len(podios2) >= 3 else 'N/A'

        # ==================== HORARIOS (TU LÓGICA ORIGINAL) ====================
